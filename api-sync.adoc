...
summary: Os recursos de cópia e sincronização do NetApp disponíveis por meio da interface do usuário da Web também estão disponíveis por meio de APIs RESTful. 
---

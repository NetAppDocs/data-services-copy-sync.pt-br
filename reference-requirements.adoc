...
---
= Requisitos de origem e destino para NetApp Copy and Sync
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Para adicionar uma chave KMS gerenciada pelo cliente, você precisará usar um agente de dados com o link:task-installing-gcp.html#permissions-required-for-the-service-account["permissões corretas"], e a chave deve estar na mesma região que o bucket.

...
https://docs.netapp.com/us-en/bluexp-classification/task-managing-highlights.html#copying-and-synchronizing-source-files-to-a-target-system["Aprenda como iniciar um relacionamento de sincronização a partir da NetApp Data Classification"^] .

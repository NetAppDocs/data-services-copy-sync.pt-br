...
* Para construir um corpo para seu relacionamento pós-namoro, https://api.cloudsync.netapp.com/docs/#/Relationships-v2/post_relationships_v2["consulte a chamada da API relationships-v2"^] .
